...
@Component
@Order(2)
public class MembershipValidationAspect {
    ...
    public void beforeValidationMembership(){
        System.out.println("=====> Executing @Before advice from MembershipValidationAspect <=====");
    }
}
